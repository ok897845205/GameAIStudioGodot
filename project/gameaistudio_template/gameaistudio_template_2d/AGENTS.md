# GameAIStudio Template 2D - Codex Agent Guide

## Project Layout
- Entry scene: `res://scenes/main.tscn`
- Player script: `res://scripts/player.gd` using `CharacterBody2D`
...
## Godot 4 API Rules
- Set the built-in 2D `velocity`, then call parameterless `move_and_slide()`.
