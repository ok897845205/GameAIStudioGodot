...
const api: StudioApi = {
  ...
  regenerateImage: (input: RegenerateAssetInput) => ipcRenderer.invoke("media:regenerate-image", input),
  ...
  regenerateAudio: (input: RegenerateAudioInput) => ipcRenderer.invoke("audio:regenerate", input),
